            ...
            <div class="panel-body">
                <form class="form-horizontal" role="form" id="picUpload" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-3">
                            <textarea class="form-control" id="remark"
                                      style="resize: none;width: 100%;height: 50px;"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="form-group" style="float: left;margin-left: 20px;">
                        <label>期限</label>
                        <div class="col-sm-3">
                            <input type="text" id="decorateTime" placeholder="输入还款期限">
                        </div>
                    </div>
                    <div class="form-group" style="float: left;margin-left: 20px;">
                        <label>月还款金额</label>
                        <div class="col-sm-3">
                            <input type="text" id="monthRepayment">
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <label>活动时间</label>
                        <div class="col-sm-3" style="margin-left: 25px;">
                            <input type="text" id="activeTime" class="form-control" placeholder="请输入活动时间">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>合作商家</label>
                        <div class="col-sm-3" style="margin-left: 25px;">
                            <input type="text" id="cooperativeBusiness" class="form-control" placeholder="请输入合作商家">
                        </div>
                    </div>
                    <div class="form-group">
                        <label>文章内容</label>
                    ...
                    <div class="modal-footer" style="text-align: left;">
                        <button type="button" class="btn btn-primary" id="addContent">
                            确定
                        </button>
...
<script>
    $(document).ready(function () {
        ...
        $("#addContent").click(function () {
            ...
            $.ajax({
                url: "${pageContext.request.contextPath}/saveContent",
                method: "post",
                dataType: "text",
                data: {
